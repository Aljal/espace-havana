  ...
  return (
    <div className="container">
      <div className="images-container">
        <div className="first">
          <img src="/elephant.jpeg" alt="elephant paint" />
          <img src="/2_femmes_main_blue.jpeg" alt="two women paint" />
          <img src="/femme_multicolor.jpeg" alt="multicolor woman paint" />
          <img src="/femme_penche_main_orange_black.jpeg" alt="women orange color" />
        </div>
        <div className="second">
          <img src="/visage_ville_lunette.jpeg" alt="face city glass" />
          <img src="/walking_african_people.jpeg" alt="walking african peopple" />
          <img src="/abstract_art_multicolor.jpeg" alt="elephant paint" />
          <img src="/abstract_art_circle.jpeg" alt="elephant paint" />
        </div>
      </div>
      <div className="text">
        ...
        <div className="social-media">
          ...
          <a href="https://www.instagram.com/espace_havana" className="instagram button">
            <img className="logo" src="/instagram_logo.png" alt="instagram logo" />
            <img className="profil-picture" src="/instagram.jpg" alt="instagram profil picture" />
